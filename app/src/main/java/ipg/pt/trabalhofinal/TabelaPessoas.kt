...
class TabelaPessoas(db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE $NOME_TABLE ( ${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $NOME_PESSOA TEXT NOT NULL, $DATA_NASCIMENTO TEXT NOT NULL, $CC TEXT NOT NULL, $MORADA TEXT NOT NULL, $CONTACTO TEXT NOT NULL, $NUM_VACINAS INT NOT NULL)")
